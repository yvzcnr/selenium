...
public class RadioButton {
    public static void main(String[] args) {
        ...
        WebElement radioBttnMale=driver.findElement(By.xpath("//input[@name='optradio' and @value='Male']"));
        radioBttnMale.click();
        //   check if you were able to select the option or not
        boolean status=radioBttnMale.isSelected();
        if(status){
